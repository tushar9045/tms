        ...
        stage('SonarQube Analysis') {
            steps {
                withSonarQubeEnv('sq-1') {
                    ...
                    sh '''
                        sonar-scanner -Dsonar.projectKey=test-2 -Dsonar.sources=. -Dsonar.host.url=http://3.109.186.253:9000 -Dsonar.login=sqp_668112afa5bad0fa29e612f3b2e637780fb30336
